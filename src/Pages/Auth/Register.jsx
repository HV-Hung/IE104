      ...
      <div className="register-container relative w-screen min-h-screen m-0 p-0 bg-[#e5e7eb]">
        <div className="register-form-container absolute w-[600px] m-auto top-[10px] left-0 right-0 pt-[80px] pb-[100px] pl-[50px] pr-[50px]">
          ...
          >
            ...
            >
              <DatePicker className="h-[50px] w-[100%]" format={dateFormat} />
            </Form.Item>
            <Form.Item label="GIỚI TÍNH" name="gender">
              <Radio.Group className="w-[300px]">
                <Radio className="text-white mr-[50px]" value={"Nam"}>
                  Nam
                </Radio>
            ...
            >
              <Button className="mt-[20px]"  id="register" type="primary" htmlType="submit">
                ĐĂNG KÝ
              </Button>

              <div className="footer flex content-center justify-center text-base mb-[8px]">
                <p className="text">
                  <span className="text-[18px] " >Đã có tài khoản?</span>  
                  
                </p>
                <a onClick={handleClick}  className="no-underline text-[18px]" href="">
                    Đăng nhập ngay
                  </a>
                  
              </div>
              <p className="text-center mt-[20px] text-[18px] mr-[5px] cursor-pointer " onClick={wayback}>Quay lại <span className="text-[18px] ml-[3px] text-[#31d7a9]">Trang chủ</span></p>
            </Form.Item>
          </Form>
        </div>
      </div>
