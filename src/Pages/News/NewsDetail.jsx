...
const deal_detail = [
  ...
  },
  {
    ...
    objects: [
      "- Khách hàng là thành viên có sinh nhật trong tháng 12."
    ],
    others: [
  ...
  },
  {
    ...
    objects: [
      "- Áp dụng cho tất cả Chủ thẻ với những đầu BIN sau: 356515"
    ],
    others: [
  ...
  },
  {
    ...
    address: "Các cụm rạp khu vực Hồ Chí Minh, Hà Nội, Bình Dương và các khu vực khác.",
    objects: [
      "- Tất cả đối tượng khách hàng."
    ],
    others: [
  ...
  return (
    <Layout>
      ...
      <div className="w-full h-850px bg-white">
        <div className="w-[1080px] h-[850px] mx-auto bg-white">
