...
const deal_detail = [
  {
    ...
    content1: "- Khách hàng mua combo có sản phẩm của Pepsi sẽ được bốc thăm trúng các phần quà hấp dẫn.",
    content2: "- Đối với combo có sản phẩm là Pepsi Black, khách sẽ được tặng thêm 1 phiếu thăm.",
    content3: "",
  ...
  },
  {
    ...
    content1: "- Khách hàng mua: 2 vé hoặc 1 Combo bất kì sẽ được tham gia chơi 01 lần trò chơi xoay vòng đá bóng vào Gôn Mini (không giới hạn số lần).",
    content2: "- Khách hàng sẽ cần xoay vòng xung quanh vị trí bóng , sau khi xoay xong sẽ phải sút trái bóng ngay trong 2s.",
  ...
  },
  {
    ...
    content1: "- Khách hàng mua 02 vé xem phim thanh toán bằng Visa Chạm sẽ được tặng 01 phần bắp ngọt.",
    content2: "",
    content3: "",
  ...
  },
  {
    ...
    content1: "- Giá vé 2D đặc biệt dành cho khách hàng là thành viên và từ 22 tuổi trở xuống.",
    content2: "",
    content3: "",
    address: "Các cụm rạp BHD Star Hồ Chí Minh, Hà Nội.",
    object1: "-  Chỉ áp dụng cho khách hàng đã kích hoạt chức năng ưu đãi U22 trên tài khoản thẻ thành viên.",
    object2: "",
    object3: "",    
  ...
  },
  {
    ...
    content1: "- Giá vé 2D đặc biệt cho khách hàng xem phim vào ngày thứ 2 hàng tuần.",
    content2: "",
    content3: "",
    address: "Tất cả các rạp BHD Star trên toàn quốc.",
  ...
  },
  {
    ...
    content1: "- Giá vé 2D đặc biệt cho khách hàng xem phim vào các suất chiếu sau 22:00.",
    content2: "",
    content3: "",
    address: "Các cụm rạp BHD Star Hồ Chí Minh, Hà Nội.",
  ...
  },
  {
    ...
    content1: "- Khách hàng mua một lần 2 vé xem phim ONE PIECE FILM RED sẽ được tặng 1 huy hiệu và 1 bìa hồ sơ hoặc 2 huy hiệu hoặc 2 bìa hồ sơ.",
    content2: "- Khách hàng mua một lần 4 vé xem phim ONE PIECE FILM RED sẽ được tặng 1 huy hiệu, 2 bìa hồ sơ và 1 giá đỡ điện thoại.",
    content3: "",
  ...
  },
  {
    ...
    content1: "- Bạn mới: Chỉ 1.000đ/vé khi thành viên U22 thanh toán bằng Ví điện tử ZaloPay.",
    content2: "",
    content3: "",
    address: "Website cgv.vn, Ứng dụng CGV Cinemas.",
    object1: "- Chỉ áp dụng cho Khách hàng là thành viên U22 của CGV.",
    object2: "- Khách hàng có độ tuổi từ 12 – 22 (trước ngày sinh nhật lần thứ 23).",
    object3: "-  Bạn mới: Lần đầu tiên liên kết thẻ/ tài khoản ngân hàng mới với ZaloPay trong thời gian diễn ra chương trình và chưa từng thực hiện giao dịch thanh toán trên ZaloPay.",    
  ...
  },
  {
    ...
    content1: "-  CGV tặng Combo 1 Bắp 2 Nước cho những khách hàng là thành viên có sinh nhật trong tháng 12.",
    content2: "",
    content3: "",
    address: "Các cụm rạp CGV trên toàn quốc.",
    object1: "- Khách hàng là thành viên có sinh nhật trong tháng 12.",
    object2: "- Thành viên có ít nhất 01 giao dịch trong vòng 12 tháng gần nhất",
    object3: "",    
  ...
  },
  {
    ...
    object1: "- Chủ thẻ tín dụng citi Việt Nam có đầu BIN: 437374, 533948, 531922, 534763, 546079.",
    object2: "",
    object3: "",    
  ...
  },
  {
    ...
    content1: "- Mua 02 vé xem phim CGV chỉ với 90.000 đồng khi mua vé trực tuyến trên ứng dụng CGV Cinema hoặc website www.cgv.vn.",
    content2: "- Chương trình chỉ áp dụng cho hạng ghế thường và hạng ghế VIP cho phim 2D. Mỗi cặp vé được áp dụng cho cùng một bộ phim, một suất chiếu và cùng hạng ghế.",
    content3: " -Chương trình bắt đầu từ 09h00 - 23h59 các ngày Thứ Năm,Thứ Sáu,Thứ Bảy và Chủ Nhât hàng tuần.",
    address: "Các cụm rạp BHD Star Hồ Chí Minh, Hà Nội và Huế..",
  ...
  },
  {
    ...
    content1: "- Khách hàng mua 01 Milo Premium Combo sẽ được tặng 01 Túi Milo Eco Friendly.",
    content2: "- 01 Milo Premium Combo (109K) gồm 02 Milo Active 01 Bắp Mix 44Oz.",
    content3: "",
...
const news_detail = [
  {
    ...
    content1: "- Cụm rạp thứ 10 của BHD Star Cineplex sẽ chính thức khai trương vào ngày 21/12/2019 tại Hà Nội với ưu đãi xem phim miễn phí cùng hàng ngàn chương trình khuyến mãi siêu khủng!.",
    content2: "",
    content3: "",
  ...
  },
  {
    ...
    content1: "- Với ứng dụng đặt vé chính thức từ BHD Star Cineplex, bạn có thể:",
    content2: "+ Đặt trước ghế đẹp mà không phải xếp hàng tại rạp.",
    content3: "+ Đồng bộ hóa quyền lợi thành viên, đặt trước đồ ăn thức uống với ưu đãi đến 20%.",
    address: "Các cụm rạp BHD trên toàn quốc.",
    object1: "- Tất cả khách hàng.",
    object2: "",
  },
  {
    ...
    date: "Từ ngày 01/12/2022",
    content1: "- Cụm rạp chiếu phim BHD Star 3/2 toạ lạc tại địa chỉ Lầu 5, Siêu Thị Vincom 3/2, 3C Đường 3/2, Quận 10, TPHCM vốn đã rất quen thuộc với giới trẻ bởi chính sách giá vé hấp dẫn..",
    content2: "- Với góc chụp ảnh đơn giản mà chất và một chương trình “tâm lý”, dễ hiểu vì sao rạp BHD Star 3/2 luôn được “play-dân” ưu ái lựa chọn. Thế nên, hãy thử đi và trải nghiệm điểm hẹn này ngay nhé!",
    content3: "",
    address: "Các cụm rạp BHD trên toàn quốc.",
    object1: "- Tất cả khách hàng.",
    object2: "",
  ...
  },
  {
    ...
    content2: "- BHD Star Huế sẽ “chào làng” vào ngày 19/5/2018, tại địa chỉ Vincom Huế, 50A Hùng Vương tổ 10, Phú Nhuận, Thành phố Huế, Thừa Thiên Huế.",
    content3: "- Với mong muốn trở thành điểm giải trí hấp dẫn mới cho khán giả Huế, BHD Star Huế còn sẵn sàng nhiều cơn bão khuyến mãi siêu hấp dẫn và sự kiện khai trương đặc sắc chờ đón khán giả “phá đảo”.",
  ...
  },
  {
    ...
    date: "Từ ngày 01/12/2022",
    content1: "- Từ ngày 15.10.2017, Đường Dây Nóng của BHD Star chính thức hoạt động. Các khách hàng thân thiết của BHD Star sẽ có thêm kênh thông tin để cập nhật tin tức, giải đáp thắc mắc một cách nhanh chóng và dễ dàng nhất.",
    content2: "- Bao điều thắc mắc không biết giải bày cùng ai, hãy gọi ngay số: 1900 2099 để được tư vấn nhanh chóng nhất.",
    content3: "",
    address: "Các cụm rạp BHD trên toàn quốc.",
    object1: "- Tất cả khách hàng.",
    object2: "",
  },
  {
    ...
    content1: "- Bắt đầu từ 02/11/2016, BHD Star chính thức khai trương cụm rạp đầu tiên tại Hà Nội: BHD STAR VINCOM PHẠM NGỌC THẠCH, tầng 8 TTTM Vincom, số 2 Phạm Ngọc Thạch, Đống Đa, Hà Nội.",
    content2: "- Nhân dịp khai trương, BHD Star Vincom Phạm Ngọc Thạch mang đến cho khán giả nhiều chương trình khuyến mãi hấp dẫn: Xem phim Miễn Phí, Phim Bom Tấn giá chỉ 30K, Thăng hạng nhanh chưa từng có, Du lịch Châu Á…",
    content3: "",
            ...
            if ((item.id) == (params.id)) {
              ...
              <div>
                  <div className="py-[30px]">
                    <h2 className="text-[22px] text-[#e71a0f] font-[500] my-[0]">{item.name}</h2>
                  </div>
                <div className="flex" >
                  <img className="w-[350px] h-fit mr-[30px]" src={item.img} alt="" />
                  <div className="">
                    <p className="text-[16px]"><b>1. Thời gian áp dụng: </b>{item.date}</p>
                    <p className="text-[16px] mb-[0]"><b>2. Nội dung chương trình: <br/></b>{item.content1}</p>
                    <p className="text-[16px] mb-[0]">{item.content2}</p>
                    <p className="text-[16px]">{item.content3}</p>
                    <p className="text-[16px]"><b>3. Địa điểm áp dụng: </b>{item.address}</p>
                    <p className="text-[16px] mb-[0]"><b>4. Đối tượng khuyến mại: <br/></b>{item.object1}</p>
                    <p className="text-[16px] mb-[0]">{item.object2}</p>
                    <p className="text-[16px]">{item.object3}</p>
                    <p className="text-[16px] mb-[0]"><b>5. Quy định khác: <br/></b>{item.other1}</p>
