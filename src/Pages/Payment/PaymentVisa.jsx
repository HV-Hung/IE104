        ...
        <div className="flex bg-[#f0f0f0] px-[16px] py-[16px] mb-[20px]">
          ...
          <div className="text-[16px] relative border-[1px] border-solid border-[#ccc] px-[16px] py-[16px] rounded-[2px]">
            <div className="mb-[24px]">
              ...
              <input className="w-full px-[4px] py-[4px] border-[1px] border-solid border-[#ccc] rounded-[4px]" id="number_card" type="text" placeholder="1234 4568 9101 1234" />
            </div>
            <div className="flex justify-between mb-[48px]">
              <div className="div">
                ...
                <input className="w-full px-[4px] py-[4px] border-[1px] border-solid border-[#ccc] rounded-[4px]" id="date_card" type="text" placeholder="12/25" />
              </div>
              <div className="div">
                <label htmlFor="csc_card">
                  <p className="mb-[8px]">CSC*</p>
                </label>
                <input className="w-full px-[4px] py-[4px] border-[1px] border-solid border-[#ccc] rounded-[4px]" id="csc_card" type="text" />
              </div>
            </div>
