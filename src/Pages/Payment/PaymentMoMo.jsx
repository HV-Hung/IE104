    ...
    <div className="w-[900px] mx-[auto] mt-[64px] flex">
      ...
      <div className="flex-1 rounded-[6px]">
        <div className="flex justify-between mx-[16px] my-[24px]">
          ...
          <img className="w-[64px]" src="https://payment.momo.vn/gw_payment/faces/javax.faces.resource/material/img/logo-1.png" alt="Logo Momo" />
        </div>
        <div className="mx-[16px]">
          ...
          <p className="text-center text-[18px] mt-[24px]" >Sử dụng App MoMo hoặc ứng dựng Camera hỗ trợ QR code để quét mã</p>
        </div>
      </div>
    </div>
